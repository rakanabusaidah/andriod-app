...
public class PrayTime {
    ...
    public ArrayList<String> getPrayerTimes(double latitude , double longitude){
        ...
        for (int i = 0; i < prayerTimes.size(); i++) {
            System.out.println("Pray Time("+i+"):"+prayerNames.get(i) + " - " + prayerTimes.get(i));
        }
        return prayerTimes;
    }
    public ArrayList<String> getPrayerTimes24h(double latitude , double longitude){
        double timezone = getTimeZone1();
        // Test Prayer times here
        PrayTime prayers = new PrayTime();
